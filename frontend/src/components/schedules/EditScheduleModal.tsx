...
import { Schedule, ScheduleUpdate, MealType } from '@/types/schedules/schedule.types';
import {
    Dialog,
    DialogTitle,
    DialogContent,
...
export default function EditScheduleModal({ schedule, open, onClose }: EditScheduleModalProps) {
    ...
    const handleInputChange = (field: keyof ScheduleUpdate) => (
